...
function [objfun, lb, ub, lincon, nonlcon, multfun, sizes, opts, pset, pfront] = wfg5(sizes, k, doval)
% WFG5 multiobjective optimization problem.
% n >= 2, nobj >= 2, n >= nobj.
...
t1 = @(y) mop.wfg.s_decept(y, 0.35, 0.001, 0.05);
