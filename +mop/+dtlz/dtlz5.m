...
function [objfun, lb, ub, lincon, nonlcon, multfun, sizes, opts, pset, pfront] = dtlz5(sizes, k, doval)
% DTLZ5 multiobjective optimization problem.
% n >= 2, nobj >= 2, n >= nobj.
...
[objfun, lb, ub, lincon, nonlcon, multfun, sizes, opts, pset] = mop.dtlz.dtlz(sizes, @dtlz5f);
pfront = @dtlz5pfront;
opts.MOPName = 'DTLZ5';

  function [fx] = dtlz5f(x)
  ...
  function [pf, m] = dtlz5pfront(m)
    pf = utils.usimplex(k, m);
